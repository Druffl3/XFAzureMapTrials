...
using XFAzureMapTrial.CustomControls;
using XFAzureMapTrial.iOS.CustomRenderers;
using ObjCRuntime;

[assembly: ExportRenderer(typeof(SSLWebView), typeof(SSLWebViewRenderer))]
namespace XFAzureMapTrial.iOS.CustomRenderers
{
    public class SSLWebViewRenderer : WebViewRenderer
    {
        public new SSLWebView Element { get { return (SSLWebView)base.Element; } }
        ...
        protected override void OnElementChanged(VisualElementChangedEventArgs e)
        {
            ...
            if (!(Delegate is SSLWebViewDelegate))
            {
                ...
                Delegate = null;
                Delegate = new SSLWebViewDelegate(this, originalDelegate);
            }
        ...
        private class SSLWebViewDelegate : UIWebViewDelegate, INSUrlConnectionDelegate
        {
            private readonly SSLWebViewRenderer _renderer;
            private readonly NSObject _originalDelegate;
            private NSUrlRequest _request;

            public SSLWebViewDelegate(SSLWebViewRenderer renderer, NSObject originalDelegate)
            {
                _renderer = renderer;
